...
```
Internet/Intranet ←→ MikroTik Router (Multi-WAN) ←→ LAN & VPN Clients
```

### اینترفیس‌ها

- **Port 1**: اتصال PPPoE به اینترانت (از طریق لینک رادیویی) - اولویت 1
- **Port 2**: اتصال بکاپ VDSL به اینترانت - اولویت 2
- **Port 3-4**: پورت‌های LAN (Bridge)
- **Port 5**: اتصال به اینترنت برای کلاینت‌های VPN
