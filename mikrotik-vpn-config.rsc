...
# 3. Client 1 public key: HRnO/GFu1WFeYWkmsU65riEUPJrDvWnU//Q69bTKmQA=
...
/interface wireguard peers
add allowed-address=192.168.200.2/32 interface=wireguard-vpn public-key="HRnO/GFu1WFeYWkmsU65riEUPJrDvWnU//Q69bTKmQA=" comment="WireGuard Client 1"
...
# =====================================================
# CLIENT 1 CONFIGURATION FILES
# =====================================================
# 
# برای راه‌اندازی کلاینت اول از یکی از روش‌های زیر استفاده کنید:
#
# روش 1: اسکن QR Code (برای موبایل)
# ------------------------------------
# فایل: client1-qrcode.png
# این فایل را با اپلیکیشن WireGuard روی موبایل اسکن کنید
#
# روش 2: فایل کانفیگ (برای دسکتاپ)
# ---------------------------------------
# فایل: client1.conf
# این فایل را در WireGuard import کنید
#
# مشخصات Client 1:
# -----------------
...
# Public Key: OkMrWI423O6h0Fgvg40RRvzWBLv1bC4CEfNi9INlph0=
# Allowed IPs: 0.0.0.0/0 (تمام ترافیک از طریق VPN)
#
# =====================================================
